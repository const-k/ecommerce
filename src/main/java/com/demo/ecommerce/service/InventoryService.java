...
public class InventoryService {
    ...
    public InventoryService(ItemRepository repository, FluentMongoOperations fluentOperations) {
    ...
    public List<Item> searchByFluentExample(String name, String description) {
